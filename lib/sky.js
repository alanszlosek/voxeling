...
var Weather = function(gl, shader, textures) {
    ...
    */
	...
	this.sunStartingPosition = vec3.fromValues(0, -200, 0);
    var d = 6;
    var uv = [
        0, 0, d, d,
        0, 0, d, d,
...
Weather.prototype.tick = function(seconds) {
    ...
    vec3.transformMat4(this.directionalLight.position, this.sunStartingPosition, this.sun.view);
    mat4.translate(this.sun.view, this.sun.view, this.sunStartingPosition);
};
