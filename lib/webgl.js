...
Core.prototype.createShaders = function() {
    // Common
    ...
    this.shaders.projectionViewPosition = createShader(
        ...
        // uniforms
        ['projection', 'view', 'texture', 'textureOffset', 'directionalLightColor', 'directionalLightVector']
    );
    ...
    this.shaders.projectionPosition = createShader(
        ...
        ['position', 'normal', 'texcoord'],
        // uniforms
        ['projection', 'texture', 'textureOffset', 'directionalLightColor', 'directionalLightVector']
    );
...
Core.prototype.render = function(ts) {
    var self = this;
    var gl = this.gl;
