...
Camera.prototype.canvasResized = function() {
    var farDistance = 640; // 32 * 20 = 640 ... 20 chunks away
    ...
    mat4.perspective(this.projection, this.verticalFieldOfView, this.ratio, 0.1, farDistance);

    this.frustum = new Frustum(this.verticalFieldOfView, this.ratio, 0.1, farDistance);
};
...
Camera.prototype.updateProjection = function() {
    ...
    this.frustum.update(this.position, this.follow.getRotationQuat());
