...
Movable.prototype.setTranslation = function(vector) {
...
Movable.prototype.setRotation = function(rotation) {
    quat.identity(this.yaw);
    quat.identity(this.pitch);
    quat.identity(this.bank);

    quat.rotateX(this.pitch, this.pitch, rotation[0]);
    quat.rotateY(this.yaw, this.yaw, rotation[1]);
    quat.rotateZ(this.bank, this.bank, rotation[2]);
}
