...
Client.prototype.bindEvents = function() {
    ...
    var messageHandlers = {
        ...
        removeVoxels: function(chunkId) {
            self.game.removeVoxels(chunkId);
        },
        // Chunk was re-meshed
        chunkMesh: function(chunkID, mesh) {
            self.voxels.showMesh(chunkID, mesh);
        },
        meshesToShow: function(meshPriority, onlyTheseMeshes) {
            self.voxels.meshesToShow(meshPriority, onlyTheseMeshes);
        },
