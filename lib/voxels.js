...
var vertexShaderCode =
    ...
    "void main() {" +
        ...
        "v_lighting = ambientLight + (u_directionalLightColor * directional);" +
...
function Voxels(gl, textures) {
    ...
    this.shaderUniforms.directionalLightColor = gl.getUniformLocation(shaderProgram, "u_directionalLightColor");
...
var chunksDrawn = 0;
Voxels.prototype.render = function(projection, ts, frustum, directionalLight) {
    var gl = this.gl;

    gl.useProgram(this.shaderProgram);
    gl.uniformMatrix4fv(this.shaderUniforms.projection, false, projection);
    gl.uniform3fv(this.shaderUniforms.directionalLightColor, directionalLight.color);
    gl.uniform3fv(this.shaderUniforms.directionalLightVector, directionalLight.vector);
