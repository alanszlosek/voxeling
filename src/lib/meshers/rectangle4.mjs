...
// try helper map for mapping textureValue to textureValue at each face
...
class RectangleMesher {
    constructor(config, voxToTex, texOffsets, coordinates, cache) {
        ...
        */
        ...
        this.faceToVoxelValue = {};
        for (let voxelValue in this.voxelsToTextures) {
            for (let i = 0; i < 6; i++) {
                if (!(i in this.faceToVoxelValue)) {
                    this.faceToVoxelValue[i] = {};
                }
                this.faceToVoxelValue[i][ voxelValue ] = this.voxelsToTextures[voxelValue].textures[i];
            }
        }
    }
            ...
            for (let y = 0; y < this.chunkWidth; y++) {
                ...
                for (let x = 0; x < this.chunkWidth; x++) {
                    ...
                    for (let faceIndex in faces) {
                        ...
                        let tryColumn = !skip;
                        let tryRow = !skip;
                        let faceVoxelValues = this.faceToVoxelValue[ faceIndex ];

                        let voxelFaceValue = faceVoxelValues[voxelValue];
                        ...
                        while (tryColumn || tryRow) {
                            while (tryColumn) {
                                ...
                                let voxelFaceValue2 = faceVoxelValues[voxelValue2];
