...
// 2021-01-21 - attempting to use stepping to calculate index
                            ...
                            while (tryColumn) {
                                ...
                                switch (bitwiseFace) {
                                    ...
                                    case this.bitwiseFaces.bottom:
                                        // TODO: can just add to index here, instead of the following
                                        index2 = newEndColumn + indexY; //(y * this.chunkWidth) + (z * this.chunkWidth2);
                                        break;
                                    case this.bitwiseFaces.left:
                                    case this.bitwiseFaces.right:
                                        // TODO: could just add chunkWidth2 here, instead
                                ...
                                // TODO: pre-compute map for quicker lookup ...
                                // voxelFacesByTexture = { bitwiseFace: { voxelValue: voxelFaceValue ... } }
